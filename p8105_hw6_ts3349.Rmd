...
I started by building a preliminary model using backward stepwise regression.  After that I compared that model to the same model but also including the covariate momage (the mother's age at delivery in years) because I have previously read that the age of the mother can have significant impacts on the birth of the child including its birthweight.  I compared the two models using ANOVA (they were nested models), but found that adding the covariate momage did not improve the model.  So in the end my final model was the one I found after performing backward stepwise regression.  
...
bootstrap_results %>% 
  ...
  geom_density() + 
  labs(
    title = "5000 Boostrap Estimates of r^2_hat",
    x = "r^2_hat",
    y = "Density",
