...
bootstrap_results %>% 
  ...
  rename(`R^2 Lower CI` = ci_lower_rsqd,
         ...
         `log(B_0_hat*B_1_hat) Lower CI` = ci_lower_log,
         `log(B_0_hat*B_1_hat) Upper CI` = ci_upper_log) %>%
  kbl(caption = "95% Confidence Intervals for R^2_hat and log(B_0_hat*B_1_hat)") %>%
